 ...
 */
public class ExtendVcfFleetWithVcfInstanceFromExistingComponents {
    private static final Logger log =
            LoggerFactory.getLogger(ExtendVcfFleetWithVcfInstanceFromExistingComponents.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(ExtendVcfFleetWithVcfInstanceFromExistingComponents.class, args);
    ...
    public static SddcSpec createSddcSpecForExtensionOfExistingVcfFleetWithExistingVcenterNsx(ApiClient vcfClient)
            throws Exception {
