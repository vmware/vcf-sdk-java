 ...
 * Operations Fleet Management and VCF Automation. <br>
 ...
 */
public class ExtendVcfFleetWithVcfInstance {
    private static final Logger log = LoggerFactory.getLogger(ExtendVcfFleetWithVcfInstance.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(ExtendVcfFleetWithVcfInstance.class, args);
