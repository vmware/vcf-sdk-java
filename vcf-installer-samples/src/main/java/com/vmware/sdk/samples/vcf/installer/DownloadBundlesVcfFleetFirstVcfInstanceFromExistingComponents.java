...
public class DownloadBundlesVcfFleetFirstVcfInstanceFromExistingComponents {
    private static final Logger log =
            LoggerFactory.getLogger(DownloadBundlesVcfFleetFirstVcfInstanceFromExistingComponents.class);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        SampleCommandLineParser.load(DownloadBundlesVcfFleetFirstVcfInstanceFromExistingComponents.class, args);
