...
/**
 * Demonstrates triggering the "transition" workflow for a group of clusters or standalone hosts for the bulk transition
 ...
 * </ul>
 */
public class BulkTransition {
    private static final Logger log = LoggerFactory.getLogger(BulkTransition.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(BulkTransition.class, args);
        ...
        try (VcenterClient client = factory.createClient(username, password, null)) {
            ...
            // Invoke extract task
            String taskId = inventoryStub.transition_Task(transitionSpec.build());
            ...
            if (entityType.equalsIgnoreCase("CLUSTER")) {
                ...
                // Hosts with status CONVERTED are transitioned to VLCM, others are not
