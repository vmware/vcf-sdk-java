...
/**
 * Demonstrates creating a cluster pair.
 *
 * <p>Sample Prerequisites: vCenter 8.0.3+
 */
public class CreateClusterPairs {
    private static final Logger log = LoggerFactory.getLogger(CreateClusterPairs.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        SampleCommandLineParser.load(CreateClusterPairs.class, args);
        ...
        String taskId = createTask(snapshotServiceClient, localClusterId, peerSiteId, peerClusterId);
    ...
    public static String createTask(
        ...
        return clusterPairs.create_Task(spec);
    }
