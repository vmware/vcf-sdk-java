...
/**
 * Demonstrates end to end workflow of vStats.
 *
 * <ul>
 *   <li>Step 1: Creation of an Acquisition Specification
 *   <li>Step 2: Query for data points filtered by cid
 * </ul>
 */
public class QueryDataPoints {
    private static final Logger log = LoggerFactory.getLogger(QueryDataPoints.class);
    ...
    public static void main(String[] args) throws Exception {
        SampleCommandLineParser.load(QueryDataPoints.class, args);
