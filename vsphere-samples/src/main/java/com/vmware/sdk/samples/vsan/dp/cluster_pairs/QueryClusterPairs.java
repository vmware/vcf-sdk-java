...
/**
 * Demonstrates querying a cluster pair.
 *
 * <p>Sample Prerequisites: vCenter 8.0.3+
 */
public class QueryClusterPairs {
    private static final Logger log = LoggerFactory.getLogger(QueryClusterPairs.class);
    ...
    public static void main(String[] args) {
        SampleCommandLineParser.load(QueryClusterPairs.class, args);
        ...
        ClusterPairsTypes.ListResult listResult = list(snapshotServiceClient);
        log.info("Task item size: {}, items: {}", listResult.getItems().size(), listResult.getItems());
    }

    public static ClusterPairsTypes.ListResult list(SnapshotServiceClient snapshotServiceClient) {
        ClusterPairs clusterPairs = snapshotServiceClient.createStub(ClusterPairs.class);
        return clusterPairs.list(null);
    }
}
