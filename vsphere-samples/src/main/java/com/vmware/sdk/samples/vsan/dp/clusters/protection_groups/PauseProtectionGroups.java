...
/**
 * Demonstrates pausing a protection group.
 *
 * <p>Sample Prerequisites: vCenter 8.0.3+
 */
public class PauseProtectionGroups {
    private static final Logger log = LoggerFactory.getLogger(PauseProtectionGroups.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        SampleCommandLineParser.load(PauseProtectionGroups.class, args);
