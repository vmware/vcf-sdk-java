...
/**
 * Demonstrates getting a virtual machine snapshot.
 *
 * <p>Sample Prerequisites: vCenter 8.0.3+
 */
public class GetVMSnapshot {
    private static final Logger log = LoggerFactory.getLogger(GetVMSnapshot.class);
    ...
    /** REQUIRED: The snapshot ID to get. */
    public static String snapshotId = "snapshot-id";

    public static void main(String[] args) {
        SampleCommandLineParser.load(GetVMSnapshot.class, args);
        ...
        SnapshotsTypes.Info info = get(snapshotServiceClient, clusterId, vmId, snapshotId);
        log.info("Got vm snapshot info for snapshot id {}: {}", snapshotId, info);
    }

    public static SnapshotsTypes.Info get(
            SnapshotServiceClient snapshotServiceClient, String clusterId, String vmId, String snapshotId) {
        Snapshots snapshots = snapshotServiceClient.createStub(Snapshots.class);
        return snapshots.get(clusterId, vmId, snapshotId);
    }
}
