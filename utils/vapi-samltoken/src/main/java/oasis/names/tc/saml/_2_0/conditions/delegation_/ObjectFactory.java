 ...
 * oasis.names.tc.saml._2_0.conditions.delegation package.
 *
...
public class ObjectFactory {
    ...
    private static final QName _Delegate_QNAME =
            new QName("urn:oasis:names:tc:SAML:2.0:conditions:delegation", "Delegate");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
     * oasis.names.tc.saml._2_0.conditions.delegation
     */
